...
public class RegistrationForm extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jComboBox2.setModel(
      new javax.swing.DefaultComboBoxModel(new String[] { "Navi Mmumbai", "Mumbai", "Thane", "Panvel" })
    );
  ...
  private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) { //GEN-FIRST:event_jButton1ActionPerformed
    ...
    try {
      ...
      PreparedStatement str = c.con.prepareStatement(
    ...
    try {
      for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
        if ("Nimbus".equals(info.getName())) {
          System.out.println("WE ARE USING NIMBUS UI");
      ...
      java.util.logging.Logger
        .getLogger(RegistrationForm.class.getName())
